...
public class Q01 {
    ...
    public static void main(String[] args) {
         ...
         * Kullanicidan alacaginiz iki sayiyi yine kullaniciya sectireceginiz
         * ===kullanıcıdan dediği icin scanner objesi olacak
         * === ik sayi diyor num1 ve num2 diye variable(bos konteyner)degiskenler atayacagız
         * ===variable degerini scannerdan alacak yani kullanıcıdan
         * ===sayiların data type i integer olsun
         * ===sectireceginiz dedigi icin sart vardır, sart varsa devreye if girecek
         *  dort islemden biri ile isleme koyup sonucun yazdiriniz
         * ==bu kısımda if in bodysi olacak
         * ===sonucu derken (aritmetik operator *-/+)
         * ve sonucu yazdir derken sout
         */
