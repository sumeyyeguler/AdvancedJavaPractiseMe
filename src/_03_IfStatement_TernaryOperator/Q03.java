...
public class Q03 {
	...
	public static void main(String[] args) {
		/* TASK :
		 *  Kullanicinin (scanner obje)  boyunu  m  ve kilosunu kg (double veri) alarak
		 *  BMI (VKE) hesaplayiniz (aritmetik ortalama var burda *-+/)

	    INFO : (bunlarda sartlarım if bunlar )
